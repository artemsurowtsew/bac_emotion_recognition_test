...
class Ui_EmotionRecognition(object):
    def setupUi(self, EmotionRecognition):
        ...
        EmotionRecognition.resize(1035, 887)
...
"}")
        ...
        self.screen_thread.setGeometry(QtCore.QRect(20, 0, 944, 722))
        self.screen_thread.setMinimumSize(QtCore.QSize(944, 722))
    ...
    def retranslateUi(self, EmotionRecognition):
        ...
        self.load_screen_button.setText(_translate("EmotionRecognition", "Завершити трансляцію"))
    ...
    def process_frame(self, frame):
        ...
        for (x, y, w, h) in faces:
            ...
            self.emotions_screen_reg.append(predicted_emotion_label)
        # Update the QLabel with the processed image
