...
# Form implementation generated from reading ui file 'C:\Users\Artem\PycharmProjects\pythonProject\modules\interface_bac2.ui'
#
...
"}")
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 10, 761, 601))
        self.tabWidget.setElideMode(QtCore.Qt.ElideNone)
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.screen_thread = QtWidgets.QLabel(self.tab)
        self.screen_thread.setGeometry(QtCore.QRect(60, 50, 640, 480))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 10, 200, 200))
        self.tabWidget.setElideMode(QtCore.Qt.ElideNone)
        self.tabWidget.setObjectName("tabWidget")
        ...
        self.screen_thread = QtWidgets.QLabel(self.tab1)
        self.screen_thread.setGeometry(QtCore.QRect(10, 10, 1920, 1080))
...
def retranslateUi(self, EmotionRecognition):
    ...
    self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("EmotionRecognition", "Tab 1"))
    self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("EmotionRecognition", "Tab 2"))
